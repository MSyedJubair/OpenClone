            ...
            <div className="mt-auto pt-8 border-t border-white/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {recentProjects.map((project) => (
                    <Link href={`/project/${project.id}`} key={project.id} className="group bg-app-surface/60 backdrop-blur-md border border-white/5 hover:border-indigo-500/40 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10_30px_rgba(99,102,241,0.15)] cursor-pointer">
